...
% TODO: what hyperparameters where used?
...
\end{quote}
While this method can not be influenced regarding the direction or strength of the steering effect, it is very easy to implement.% and will serve as a steering baseline to compare the other methods against.
