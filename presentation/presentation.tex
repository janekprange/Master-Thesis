    ...
    \item<2-> Askx Data
          \onslide<4->{
            \begin{itemize}
              ...
              \item will be used to test the of the style vector on a foreign domain
            \end{itemize}
          }
...
\begin{frame}{SFAM}{Style Feature Agreement Model\footauthorcite{patelLearningInterpretableStyle2023}}
  \begin{itemize}
    ...
    \item gets a style sentence and a text as input and outputs a agreement score between \num{0} and \num{1}
    \item these agreement scores form the style vector
    \item is trained on the (unclustered) sentences
          % TODO: performance
  \end{itemize}
\end{frame}
...
\begin{frame}{LISA}{Linguistically Interpretable Style Attribute\footauthorcite{patelLearningInterpretableStyle2023}}
  \begin{itemize}
    ...
    \item is trained on style vectors that are produced by SFAM
          % TODO: performance
  \end{itemize}
\end{frame}
...
\begin{frame}{Activation Steering}{Concept}
  \begin{itemize}
    ...
    \item during steering, the activation vector is added to the at the layer it was taken
  \end{itemize}
\end{frame}
